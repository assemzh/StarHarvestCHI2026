                ...
                <div className="bg-white rounded-lg shadow-lg p-8 max-w-2xl mx-auto">
                    <div className="mb-6">
                        ...
                        <p className="text-gray-600 mb-4">
                            We found another player for you to play with. Here's how your teams will look:
                        </p>
                    </div>
                    ...
                    <p className="text-gray-500 text-xs mt-4">
                        The game will start automatically when both players confirm they're ready.
                    </p>
                </div>
            </div>
        );
        ...
        <div className="text-center">
            <div className="bg-white rounded-lg shadow-lg p-8 max-w-md mx-auto">
                <div className="mb-6">
                    ...
                    <h2 className="text-2xl font-bold mb-2 text-gray-800">Waiting for players to join...</h2>
                    <p className="text-gray-600 mb-4">
                ...
                <div className="mb-6">
                    ...
                    <p className="text-sm text-gray-500">
                        {humanPlayers} players joined the queue
                    </p>
                </div>
                ...
                <div className="bg-blue-50 rounded-lg p-4 mb-6">
                    ...
                    <div className="text-sm text-blue-700 space-y-1">
                        <p>• 2 human players + 2 bot teammates</p>
