...
export const joinQueue = mutation({
    ...
    handler: async (ctx) => {
        ...
        if (validWaitingGame) {
            ...
            const botStrategy = await generateBotStrategy(ctx);
...
export const executeLockInternal = internalMutation({
    ...
    handler: async (ctx, args) => {
        ...
        // Advance turn after a delay to allow ray effect to be visible
        await ctx.scheduler.runAfter(800, internal.game.advanceTurn, { gameId: args.gameId });
    },
});
