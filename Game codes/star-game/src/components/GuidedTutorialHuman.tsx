...
interface GuidedTutorialHumanProps {
    onComplete: () => void;
}
...
const tutorialSteps = [
    ...
    },
    {
        id: "your-team",
        title: "Your Team",
        description: "🤝 You will be teamed up with <span style='color: #2c5282; font-weight: bold;'>another human player</span>. Your team will have <span style='color: #2c5282; font-weight: bold;'>same color</span> and <span style='color: #2c5282; font-weight: bold;'>icon shape</span>.",
    ...
    },
    {
        id: "opponent-team",
        title: "Opponent Team",
        description: "⚔️ Your <span style='font-weight: bold; color: #e53e3e;'>opponents</span> are also human players but in different color and shape.",
...
export function GuidedTutorialHuman({ onComplete }: GuidedTutorialHumanProps) {
