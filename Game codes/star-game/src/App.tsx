...
import { GuidedTutorialHuman } from "./components/GuidedTutorialHuman";
...
function Content() {
  ...
  const botCondition = searchParams.get("GAME_CONDITION");
  ...
  const getBotCondition = () => {
    if (botCondition === "unaware") {
      return "unaware";
    }
    return "aware";
  };

  const getTutorialComponent = () => {
    return <GuidedTutorialHuman onComplete={handleTutorialComplete} />;
  };
      ...
      <div className="text-center">
        <Authenticated>
          <div className="flex-1 flex flex-col">
            <Routes>
              <Route path="/" element={getTutorialComponent()} />
